...
import {
  Package, ShoppingCart, DollarSign, AlertTriangle, Activity, TrendingUp
} from "lucide-react";
import {
...
const Dashboard = ({ userRole }: DashboardProps) => {
  ...
  const [categoryData] = useState([
    { name: "prod1", value: 400, color: "#3b82f6" },
    { name: "prod2", value: 300, color: "#ef4444" },
    { name: "prod3", value: 300, color: "#22c55e" },
    { name: "prod4", value: 200, color: "#f59e0b" }
  ]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {getVisibleStats().map((stat, index) => {
          ...
          return (
            <Card
              key={stat.title}
              className="animate-slide-up shadow-elegant hover:shadow-lg transition-all duration-200"
